...
while draw:
    ...
    textsin2 = font.render("sin", True, red)
    textcos1 = font.render("- -", True, blue)
    textcos2 = font.render("cos", True, blue)
    screen.blit(textsin1, (665, 65))
    screen.blit(textcos1, (665, 80))
    screen.blit(textsin2, (680, 65))
    screen.blit(textcos2, (685, 80))
